...
},{"./../core/string":17}],16:[function(require,module,exports){
'use strict';
...
},{"./../ajax/xhr":15,"./../core/map":16,"react":"react"}],19:[function(require,module,exports){
'use strict';
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./ajax/xhr":15,"./decorator/store":18}],20:[function(require,module,exports){
'use strict';
...
},{"../common/config":20,"./dashboard/dashboard":23,"./notfound":24,"./search/search":27,"./test/test":28,"ext-react":13,"react":"react"}],22:[function(require,module,exports){
'use strict';
...
},{"../../common/config":20,"../../stores/dashboard":33,"../../ux/viz":35,"ext-react":13,"react":"react"}],24:[function(require,module,exports){
'use strict';
...
},{"../../services/card":30,"../bootstrap":22,"react":"react"}],26:[function(require,module,exports){
'use strict';
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('div', { text: 'ID', dataIndex: 'Id', width: 150 }),
          _react2.default.createElement('div', { text: 'Name', dataIndex: 'Name', width: 250 }),
          _react2.default.createElement('div', { text: 'Type', dataIndex: 'Type', width: 150 }),
          _react2.default.createElement('div', { text: 'Introduction', dataIndex: 'Introduction', width: 1000 }),
          ...
          _react2.default.createElement('div', { text: 'Armor', dataIndex: 'ArmorUsable', width: 200 }),
          _react2.default.createElement('div', { text: 'Weapon', dataIndex: 'WeaponUsable', width: 200 })
        )
      );
    }
  }]);
...
},{"../../stores/card":32,"../../ux/grid":34,"react":"react"}],27:[function(require,module,exports){
'use strict';
...
},{"./search-form":25,"./search-result":26,"react":"react"}],28:[function(require,module,exports){
'use strict';
...
},{"rc-model":19,"react":"react"}],29:[function(require,module,exports){
'use strict';
...
},{"./components/app":21,"./services/common":31,"babel-polyfill":"babel-polyfill","ext-react":13}],30:[function(require,module,exports){
'use strict';
...
},{"../stores/card":32,"ext-react":13}],31:[function(require,module,exports){
'use strict';
...
},{"../common/config":20,"ext-react":13}],32:[function(require,module,exports){
'use strict';
...
var Grid = function (_Component) {
  ...
  _createClass(Grid, [{
    ...
    value: function componentDidMount() {
      ...
      this.resizeGrid();
      (0, _jquery2.default)(window).on('resize', this.resizeGrid.bind(this));

      var node = (0, _reactDom.findDOMNode)(this),
          header = (0, _jquery2.default)(node).find('.bootgrid-header');

      (0, _jquery2.default)(node).find('.bootgrid-body').on('scroll', function () {
        header.scrollLeft((0, _jquery2.default)(this).scrollLeft());
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'section',
        { className: 'bootgrid', style: { width: outerWidth, height: outerHeight } },
        _react2.default.createElement(
          'div',
          { className: 'bootgrid-header', style: { width: outerWidth } },
          _react2.default.createElement(
            'div',
            { className: 'd-flex flex-row bootgrid-header-container', style: { width: headerWidth } },
            columns.map(function (col) {
              var text = col.text,
                  width = col.width,
                  others = _objectWithoutProperties(col, ['text', 'width']);

              return _react2.default.createElement(
                'div',
                _extends({ className: 'bootgrid-column-header text-sm-center' }, others, { style: { width: width } }),
                text || ''
              );
            })
          )
        ...
        _react2.default.createElement(
          'div',
          { className: 'bootgrid-body', style: { width: outerWidth, height: bodyHeight } },
          _react2.default.createElement(
            'div',
            { className: 'd-flex flex-column bootgrid-view', style: { width: bodyWidth } },
            data.map(function (record) {
              return _react2.default.createElement(
                'div',
                { className: 'd-flex flex-row bootgrid-row' },
                columns.map(function (col) {
                  var dataIndex = col.dataIndex,
                      width = col.width,
                      others = _objectWithoutProperties(col, ['dataIndex', 'width']);

                  return _react2.default.createElement(
                    'div',
                    _extends({ className: 'bootgrid-cell' }, others, { style: { width: width } }),
                    record[dataIndex]
                  );
                })
              );
...
},{"ext-react":13,"jquery":14,"react":"react","react-dom":"react-dom"}],35:[function(require,module,exports){
'use strict';
